...
import com.example.drainjava.drain.profiler.NullProfiler;
import com.example.drainjava.drain.profiler.Profiler;
...
@Getter
@Setter
public abstract class AbstractDrainBase {
